...
### Loading of the data
We load the generated **subread_counts** object, define the experimental conditions for each available sample and prepare the data in the _DGEObj_ format.
...
### Experimental Design
We make an experimental design matrix where we indicate the condition and replicate ID's for each sample. We then prepare the needed *EGF_vs_PBS* contrast.
